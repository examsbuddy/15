      ...
      <div className="bg-white w-full max-w-2xl mx-4 rounded-t-2xl md:rounded-xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-4 space-y-6">
          ...
          <div className="bg-blue-50 p-4 rounded-xl border border-blue-200">
            <label className="block text-sm font-medium text-blue-900 mb-2">📍 Location (Recommended)</label>
            <select
              value={filters.city}
          ...
          <div>
            <label className="flex items-center space-x-3">
              ...
              />
              <span className="text-sm font-medium text-gray-700">🛡️ With Warranty Only</span>
            </label>
          </div>
        </div>
...
export const EnhancedSearchResults = ({ 
  ...
  const quickFilters = [
    { key: 'city', label: 'City', options: ['Karachi', 'Lahore', 'Islamabad', 'Rawalpindi'] },
    { key: 'priceRange', label: 'Price', options: ['Under ₨50K', '₨50K-₨100K', '₨100K-₨200K', 'Above ₨200K'] },
    { key: 'brand', label: 'Brand', options: ['Apple', 'Samsung', 'Xiaomi', 'Oppo'] },
    { key: 'condition', label: 'Condition', options: ['New', 'Like New', 'Excellent', 'Good'] }
  ];
