        ...
        <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="lg:w-1/2 p-6">
              <div className="relative bg-gray-50 rounded-xl overflow-hidden mb-4">
                <img
                  src={listing.photos?.[currentImageIndex] || '/api/placeholder/400/400'}
                  alt={`${listing.brand} ${listing.model}`}
                ...
                {listing.photos?.length > 1 && (
                  <>
                    ...
                    <button
                      onClick={() => setCurrentImageIndex(Math.min(listing.photos.length - 1, currentImageIndex + 1))}
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-gray-50 p-3 rounded-lg">
                    ...
                    <div className="font-medium">{listing.storage}</div>
                  </div>
                  <div className="bg-gray-50 p-3 rounded-lg">
                  ...
                  <div className="bg-gray-50 p-3 rounded-lg">
                    ...
                    <div className="font-medium">{listing.ram}</div>
                  </div>
                  <div className="bg-gray-50 p-3 rounded-lg">
                    <div className="text-sm text-gray-600">Screen</div>
                    <div className="font-medium">{listing.screen_size}</div>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <div>
                      ...
                      <div className="text-sm text-gray-600">{listing.seller_type}</div>
                    </div>
                    <div className="flex items-center">
                      <Star className="w-4 h-4 text-yellow-400 fill-current" />
                      <span className="ml-1 text-sm">4.8 (127 reviews)</span>
                    </div>
                  </div>
          ...
          <div className="p-6 border-t">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                <h3 className="text-lg font-semibold mb-3">Full Specifications</h3>
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-600">Camera:</span>
                    <span>{listing.camera}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Battery:</span>
                    <span>{listing.battery}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Network:</span>
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-600">OS:</span>
                    <span>{listing.operating_system}</span>
                  </div>
                </div>
              </div>
            </div>
